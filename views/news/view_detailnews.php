...
<div class="listprod_content">
    ...
    <article class="grid_detailpro">
        ...
        <div class="box-images">
             ...
             src="<?=BASE_URL."data/NhiepAnh/".$data['info']['images'];?>" />
        </div>
        <div class="desc-info">
       ...
       <div class="item-prod">
          <div class="images">
             <a href="<?=BASE_URL."nhiep-anh/".$data['cat']['alias']."/".$item['alias'].".html";?>">
               <img class="listpro_img" alt="<?=$item['title_'.lang];?>" src="<?=BASE_URL."data/NhiepAnh/".$item['images'];?>" />
             </a>
          </div>
          <h2><a href="<?=BASE_URL."nhiep-anh/".$data['cat']['alias']."/".$item['alias'].".html";?>"><?=$item['title_'.lang];?></a></h2>
          <div class="listprod_mota"><?=$item['description_'.lang];?></div>
          <div class="listprod_xemtiep"><a href="<?=BASE_URL."nhiep-anh/".$data['cat']['alias']."/".$item['alias'].".html";?>"><?=XEMTIEP?></a></div>
       </div>
       <?php }} ?>
    </aside>
    <!----------------------->
...
<script type="application/ld+json">
{
  ...
  {
    "@type": "ImageObject",
    "url": "<?=BASE_URL."data/NhiepAnh/".$data['info']['images'];?>",
    "height": 800,
    "width": 800
  },
  "datePublished": "<?=date('d-m-Y',$data['info']['date']);?>",
  "dateModified": "<?=date('d-m-Y',$data['info']['date']);?>",
  "author": 
  {
    "@type": "Person",
    "name": "Vũ Công Thành"
