...
<div class="listprod_content">
    ...
    <article class="grid_detailpro">
        ...
        <div class="box-images">
             <img class="theme_hinhanh" id="theme_hinhanh" src="<?=BASE_URL."data/Seo/".$data['prod']['images'];?>" />
        </div>
        <div class="desc-info">
    ...
    <aside class="prod_cungloai">
        <?php
          ...
          foreach($data['spcl'] as $item){
			  $info_cat = $mcat->getOneCatelog($item['idcat']);
        ?>
        <div class="item-prod">
            <div class="images">
            <a href="<?=BASE_URL."seo/".$info_cat['alias']."/".$item['alias'].".html";?>">
               <img class="listpro_img" src="<?=BASE_URL."data/Seo/".$item['images'];?>" />
            </a>
            </div>
            <h2><a href="<?=BASE_URL."seo/".$info_cat['alias']."/".$item['alias'].".html";?>"><?=$item['title_'.lang];?></a></h2>
            <div class="listprod_mota"><?=$item['description_'.lang];?></div>
            <a href="<?=BASE_URL."seo/".$info_cat['alias']."/".$item['alias'].".html";?>"><div class="listprod_xemtiep"><?=XEMTIEP?></div></a>
        </div>
        <?php }} ?>
        <div style="clear:both"></div>
    </aside>
...
<script type="application/ld+json">
{
  ...
  {
    "@type": "ImageObject",
    "url": "<?=BASE_URL."data/Seo/".$data['prod']['images'];?>",
    "height": 800,
    "width": 800
  },
