...
<div class="main_area">
    ...
    <table border="0">
       <tr>
          ...
          <td> Quản lý nội dung / Khóa Học / sửa</td>
       </tr>
    </table>
    </div>
</div>
...
<div class="content">
<div class="content_i">
<form action='<?=BASE_URL_ADMIN."weblink/edit/".$data['info']['Id']?>' method='post' enctype="multipart/form-data">
<table>
<tr>
   ...
   <table class="right_new" >
      <tr>
        ...
        <td><input type='text' name='location' value='<?=$data['info']['location'];?>' size = '40'></td>
      </tr>
      
      <tr>
        <td class = 'title_td'>Giảng Viên</td>
        <td><input type='text' name='giangvien' value='<?=$data['info']['giangvien'];?>' size = '40'></td>
      </tr>
    
      <tr>
        <td class = 'title_td'>Link</td>
        <td><input type='text' name='link' value='<?=$data['info']['link'];?>' size = '50'></td>
      </tr>
      ...
      <tr>
          ...
          <td>
              <div id="images">
              <img src="<?=BASE_URL."data/KhoaHoc/".$data['info']['images']?>" height="50">
              <a href="javascript:delFlash('<?=TBL_WEBLINK?>','images',<?=$data['info']['Id']?>,'<?=$data['info']['images'];?>','images','
