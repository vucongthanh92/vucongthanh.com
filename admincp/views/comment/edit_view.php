...
<form name="frm" action='<?=BASE_URL_ADMIN."comment/edit/".$data['info']['Id'];?>' method='post' onsubmit="return checkform();" enctype="multipart/form-data">
<table>
<tr>
   <td width="780">
   <table>
   ...
   <table class="right_new">
      ...
      <?php if($data['info']['images'] !=""){ ?>
         ...
         <td> <img src="<?=BASE_URL."data/SaiGon/".$data['info']['images'];?>" height="100" /></td>  
      </tr>
      <?php } ?>
      <tr>
      ...
      <tr>
         ...
         <td>
            <select name="hot">
                <option value="1" <?php if($data['info']['hot']==1) echo 'selected="selected"';?> >Bật</option>
                <option value="0" <?php if($data['info']['hot']==0) echo 'selected="selected"';?>>Tắt</option>
            </select>
         </td>
      </tr>
