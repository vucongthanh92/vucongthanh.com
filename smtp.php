...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="Dealxinh.com")
{
      ...
      $smtp_host ='123.30.174.118';//Dia chi mail server
      $admin_email = 'info@oly.vn';//User duoc khai bao tren mail server
      $smtp_username = 'info@oly.vn';//User duoc khai bao tren mail server
      $smtp_password = 'Z1ckY7GA';//Pass cua email nay
...
//Test send mail
SendMail("vquyen2790@gmail.com","vquyen2790@gmail.com","Details of Booking Form","Content Testing");
